...
Sidebar.prototype.addBpmnPalette = function(dir, expand)
{
	...
	this.addStencilPalette('bpmn', 'Bussiness Process Model', dir + '/bpmn.xml',
		...
		function(content)
		{
			content.appendChild(this.createVertexTemplate('swimlane;horizontal=1;', 300, 160, 'Divisi'));
                        content.appendChild(this.createVertexTemplate('swimlane;horizontal=1;', 300, 160, 'Entitas'));
                        
			var classCell = new mxCell('Process', new mxGeometry(0, 0, 140, 60),
		    	'rounded=1');
			classCell.vertex = true;
                        classCell.onInit = function(){
                            this.setAttribute('khayat', 'ganteng');
                        }
                        
                        
                        //classCell.setAttribute('khayat', 'ganteng');
			content.appendChild(this.createVertexTemplateFromCells([classCell], 140, 60));	
                        
                        content.appendChild(this.createVertexTemplate('rhombus;horizontal=1;', 140, 60, 'Kondisi'));
