...
EditorUi.prototype.menubarTop = 40;
/**
...
EditorUi.prototype.refresh = function()
{
	...
	this.toolbarContainer.style.top = this.menubarTop + this.menubarHeight + 'px';
	this.toolbarContainer.style.height = this.menubarTop + this.toolbarHeight + 'px';
	this.sidebarContainer.style.top = this.menubarTop + (this.menubarHeight + this.toolbarHeight) + 'px';
...
EditorUi.prototype.createDivs = function()
{
	...
	this.menubarContainer.style.top = '40px';
	...
	this.toolbarContainer.style.right = '0px';
        ...
        //this.sidebarContainer.style.top = '125px';
	this.sidebarContainer.style.left = '0px';
        
        this.outlineContainer.style.left = '0px';
        
        //this.diagramContainer.style.top = '125px';
