...
Actions.prototype.init = function()
{
	...
	this.put('editFile', new Action(mxResources.get('edit'), mxUtils.bind(this, function()
	{
        ...
        this.addAction('simpanDiagram', function() {
            var xmlString = mxUtils.getXml(editor.getGraphXml());
            //alert(xmlString);
            mxUtils.post(site_url+'/index.php/bpm/default/saveDiagram', 'xml='+xmlString, function(req)
            {
                alert(req);
	...
	this.addAction('print', function() { ui.showDialog(new PrintDialog(ui).container, 300, 200, true, true); }, null, 'sprite-print', 'Ctrl+P');
        ...
        this.addAction('quit', function() { if(confirm('Anda yakin ingin keluar tanpa ada perubahan diagram?')){document.location.href=HOME_URL} });
